...
def func_lectura(month,day,ts):
    ...
    try:
        ...
        json_data.update({'v91':"El precio total del periodo visualizado es de: "+str(prft.currency(float(P_total), grouping=True))+", este periodo muestra un total de "+str(vf_ac)+" kWh"})
